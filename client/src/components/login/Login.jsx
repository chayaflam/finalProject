        ...
        <div className="card flex justify-content-center">
            ...
            <form onSubmit={handleSubmit(loginHandleSubmit)}>
                <Dialog
                    ...
                    content={({ hide }) => (
                        <div className="flex flex-column px-8 py-5 gap-4" style={{ borderRadius: '12px', backgroundImage: ' radial-gradient(circle at left top,rgb(129 191 244),rgb(129 191 244))' }}>
                            ...
                            <div className="inline-flex flex-column gap-2">
                                ...
                                <InputText type="username" id="username" name="username" {...register("username")} label="Username" className="bg-white-alpha-20 border-none p-3 text-primary-50"></InputText>
                            </div>
                            <div className="inline-flex flex-column gap-2">
                                <label htmlFor="username" className="text-primary-50 font-semibold">
                                    Password
                                </label>
                                <InputText type="password" name="password" id="password" {...register("userPassword")} label="Password" className="bg-white-alpha-20 border-none p-3 text-primary-50" ></InputText>
                            </div>
                            <div className="flex align-items-center gap-2">
                                <Button type="submit" value="Submit" label="Sign-In" onClick={(e) =>{hide(e)} } text className="p-3 w-full text-primary-50 border-1 border-white-alpha-30 hover:bg-white-alpha-10"></Button>
                                <Button label="Cancel" onClick={()=> loginHandleSubmit()} text className="p-3 w-full text-primary-50 border-1 border-white-alpha-30 hover:bg-white-alpha-10"></Button>
                            </div>
                        </div>
                    )}
                ></Dialog>
