            ...
            <Dialog
                ...
                content={({ hide }) => (
                    <form onSubmit={handleSubmit(loginHandleSubmit)}>
                        <div className="flex flex-column px-8 py-5 gap-4" style={{ borderRadius: '12px', backgroundImage: 'radial-gradient(circle at left top, rgb(255 252 245), rgb(255 252 245))' }}>
                            ...
                            <div className="inline-flex flex-column gap-2">
                                ...
                                <InputText  type="username" id="username" name="username" {...register("username")} label="Username" className="bg-write-blue-alpha-20 border-none p-3 text-primary-50 "></InputText>
                            </div>
                            <div className="inline-flex flex-column gap-2">
                                <label  htmlFor="username" className="text-primary-50 font-semibold">
                                    Password
                                </label>
                                <InputText  type="password" name="password" id="password" {...register("userPassword")} label="Password" className="bg-write-blue-alpha-20 border-none p-3 text-primary-50 " ></InputText>
                            </div>
