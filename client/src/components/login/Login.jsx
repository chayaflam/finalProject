...
export default function Login() {
  ...
  const loginHandleSubmit = (data) => {
      ...
      fetch(`${URL}/auth/login`, {
          ...
          localStorage.setItem('user', JSON.stringify({ username: data.username, id: dataFromServer.id,status:dataFromServer.statusUser }))
          navigate(`/${dataFromServer.statusUser}/${data.username}`);
      }).catch(error => { alert("Error:" + error) })
  }
